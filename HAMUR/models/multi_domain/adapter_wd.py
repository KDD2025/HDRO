...
class WideDeep_MD(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        for d in range(self.num_domains):
            ...
            domain_input_wide = model_list[0](domain_input_wide)  # cn
            domain_input_deep = model_list[1](domain_input_deep)  # mlp
            y = domain_input_wide + domain_input_deep
            out.append(torch.sigmoid(y))
